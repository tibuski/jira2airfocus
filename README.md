...
4. Create new items in Airfocus for JIRA issues that don't already exist
...
The script requires a custom field named **"JIRA-KEY"** in your Airfocus workspace to store JIRA issue keys and prevent duplicates. Create this field if it doesn't exist:
