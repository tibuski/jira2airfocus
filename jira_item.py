...
class JiraAssignee:
    ...
    @classmethod
    def from_jira_data(cls, assignee_data: Optional[Dict[str, Any]]) -> Optional['JiraAssignee']:
...
class JiraStatus:
    ...
    @classmethod
    def from_jira_data(cls, status_data: Optional[Dict[str, Any]]) -> Optional['JiraStatus']:
...
class JiraAttachment:
    ...
    def from_jira_data(cls, attachment_data: Dict[str, Any]) -> 'JiraAttachment':
        ...
        attachment_url = attachment_data.get("url") or attachment_data.get("content", "")
        
        return cls(
            filename=attachment_data.get("filename", ""),
            url=attachment_url,
            thumbnail=attachment_data.get("thumbnail") if attachment_data.get("thumbnail") else None
        )
...
class JiraItem:
    ...
    @classmethod
    def from_jira_api_data(cls, issue_data: Dict[str, Any], project_key: str, base_url: str) -> 'JiraItem':
        """
    ...
    def build_markdown_description(self) -> str:
        ...
        # Add description
        jira_description = self.description if self.description else 'No description provided in JIRA.'
        ...
        if self.attachments:
            ...
            if invalid_attachments:
                logger.warning("JIRA issue {} has {} invalid attachments: {}", 
                             self.key, len(invalid_attachments), 
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "status": {
                ...
                } if self.status.category_key else None
